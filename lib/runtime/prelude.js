...
function newType(name, value) {
  ...
  generics = value.object ? value.object.generics : 0;

  meth = rt.method(name, [ [ generics, 0 ] ], function () {
    return rt.withGenerics(name, value, arguments);
  });

  meth.isStatic = true;
  meth.value = rt.withGenerics(name, value, []);
  return meth;
}
