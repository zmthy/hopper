...
var Bool, Do, Done, Foreign, Node, Pattern, Sequence, Unknown,
...
exports.Event = type("Event", 1, [defs.signature("apply", ["value"])]);
...
(function () {
  ...
  for (i = 2; i < 10; i += 1) {
    ...
    exports["Event" + i] =
      type("Event" + i, i, [defs.signature("apply", params)]);
  }
}());
...
exports.String =
  type("String", [Pattern, Sequence], [defs.signature("asPrimitiveString")]);
