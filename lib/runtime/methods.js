...
var Task, defs, dictionary, list, pattern, prim, renamed, rt, set, types, util;
...
exports.delegateTo = rt.constructor("delegateTo()", rt.gte(1),
  function (object) {
    ...
    return Task.each(delegates, function (delegate) {
      util.forAllProperties(delegate, function (name, value) {
        var method;
      ...
      if (util.owns(delegate, "object")) {
        object.object = delegate.object;
      }
    }).then(function () {
      return object;
    });
...
renamed.annotateObject = rt.method("annotateObject()", 1, function (object) {
  object.object = object.object || {};
  object.object.isRenamed = true;
  return defs.done;
});

renamed.asString = rt.method("asString", 0, function () {
  return defs.string("renamed");
});

exports.renamed = rt.method("renamed", 0, function () {
  return renamed;
});
