...
var Task, defs, dictionary, list, pattern, prim, rt, set, types, unnamed, util;
...
unnamed.annotateLet = rt.method("annotateLet()", 1, function (decl) {
  decl.isUnnamed = true;
  return defs.done;
});

unnamed.asString = rt.method("asString", 0, function () {
  return defs.string("unnamed");
});

exports.unnamed = rt.method("unnamed", 0, function () {
  return unnamed;
});
