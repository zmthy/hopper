...
function Block(parameters, apply) {
  ...
  if (paramCount === 1) {
    this.match = rt.method("match()", 1, function (object) {
      return this.apply(object).then(function (result) {
        return defs.success(result);
      });
    });
  }
}
...
addMethod(AbstractBoolean, "andAlso()", [[1, 1]], function (T, action) {
  ...
  return defs.Action.assert(action).then(function () {
    return self.andAlso_orElse(rt.part([T], [action]),
...
addMethod(AbstractBoolean, "orElse()", [[1, 1]], function (T, action) {
  ...
  // TODO Test Action here without causing a stack overflow.
  return self.andAlso_orElse([defs.block(0, function () {
    return self;
  })], rt.part(T, [action]));
});
...
addMethod(AbstractBoolean, "&&", 1, function (rhs) {
  ...
  return defs.Boolean.assert(rhs).then(function () {
    return self.andAlso(rt.part([defs.Boolean], [defs.block(0, function () {
      return rhs;
    })]));
  });
});
...
addMethod(AbstractBoolean, "||", 1, function (rhs) {
  ...
  return defs.Boolean.assert(rhs).then(function () {
    return self.orElse(rt.part([defs.Boolean], [defs.block(0, function () {
      return rhs;
    })]));
  });
});
...
addMethod(AbstractBoolean, "prefix!", 0, function () {
  return this
    .andAlso_orElse(rt.part([defs.Boolean], [defs.block(0, function () {
...
addMethod(TypeProxy, "match()", 1, function () {
  return this.asString().then(function (name) {
    return defs.UninstantiatedType.raiseForName(name);
  });
});
...
function getElements(self) {
  ...
  return self.doForEach(defs.block(1, function (element) {
  ...
  return this.pattern().then(function (pattern) {
    return new Task(function (resolve, reject) {
      defs.List.match(list).then(function (isList) {
        return isList.andAlso_orElse([defs.block(0, function () {
          return list.doForEach(defs.block(1, function (value) {
            return new Task(function (next, reject) {
              pattern.match(value).then(function (matched) {
                return matched.andAlso_orElse([defs.block(0, function () {
                  next(rt.done);
                  return Task.never();
                })], [defs.block(0, function () {
