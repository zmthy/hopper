...
addMethod(GraceString, "substringFrom() to()", [1, 1], function (from, to) {
  ...
  return defs.Number.cast(from[0]).then(function (from) {
    return defs.Number.cast(to[0]).then(function (to) {
      return self.asPrimitiveString().then(function (self) {
        return from.asPrimitiveNumber().then(function (from) {
          return to.asPrimitiveNumber().then(function (to) {
...
addMethod(GraceString, "substringFrom() size()", [1, 1], function (from, size) {
  ...
  return defs.Number.cast(from[0]).then(function (from) {
    return defs.Number.cast(size[0]).then(function (size) {
      return self.asPrimitiveString().then(function (self) {
        return from.asPrimitiveNumber().then(function (from) {
...
addMethod(GraceString, "replace() with()", [1, 1], function (from, to) {
  ...
  return defs.String.cast(from[0]).then(function (from) {
    return defs.String.cast(to[0]).then(function (to) {
      return self.asPrimitiveString().then(function (self) {
        return from.asPrimitiveString().then(function (from) {
          return to.asPrimitiveString().then(function (to) {
...
addMethod(GraceString, "startsWith()", 1, function (prefix) {
  ...
  return defs.String.cast(prefix).then(function (prefix) {
    return self.asPrimitiveString().then(function (self) {
      return prefix.asPrimitiveString().then(function (prefix) {
...
addMethod(GraceString, "endsWith()", 1, function (suffix) {
  ...
  return defs.String.cast(suffix).then(function (suffix) {
    return self.asPrimitiveString().then(function (self) {
      return suffix.asPrimitiveString().then(function (suffix) {
...
function addIndexOfs(forwards) {
  ...
  addMethod(GraceString, method + "() startingAt() ifAbsent()", [1, 1, [1, 1]],
    function (search, from, ifAbsent) {
      ...
      return defs.String.cast(search[0]).then(function (search) {
        return defs.Number.cast(from[0]).then(function (from) {
          return defs.Action.cast(ifAbsent[1]).then(function (absent) {
            return self.asPrimitiveString().then(function (self) {
              return search.asPrimitiveString().then(function (search) {
                return from.asPrimitiveNumber().then(function (from) {
                  var index;
...
addMethod(Sequence, "asPrimitive", 0, function () {
  return this.asPrimitiveArray().then(function (array) {
    return Task.each(array, function (element) {
