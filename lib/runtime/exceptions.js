...
Exception.refine(str("Error")).then(function (Error) {
...
Err.refine(str("Internal Error")).then(function (InternalError) {
...
Err.refine_withDefaultMessage([str("Uninstantiated Type")],
...
Err.refine_withDefaultMessage([str("Invalid Request")],
...
Err.refine(str("Invalid Method")).then(function (InvalidMethod) {
...
Err.refine(str("Invalid Return")).then(function (InvalidReturn) {
