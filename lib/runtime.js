  ...
  body = function () {
    ...
    return Task.each(partCounts, argParts, function (partCount, argPart) {
      ...
      if (value === null || value === undefined) {
        return defs.InternalError.raiseMessage(defs
  ...
  if (!ours) {
    if (typeof func === "function") {
      ...
      func = method(pretty, function () {
        ...
        return Task.each(util.slice(arguments), function (arg) {
          if (typeof arg.asPrimitive === "function") {
            return arg.asPrimitive();
          }
          ...
          if (typeof result === "boolean") {
            return defs.bool(result);
          }

          if (typeof result === "number") {
            return defs.number(result);
          }

          if (typeof result === "string") {
            return defs.string(result);
          }

          if (typeof result === "function") {
            return defs.block(result);
          }
