...
Parser.prototype = {
  ...
  parameter: lookahead.parsers("parameter", "identifier", "underscore",
    function (name) {
  ...
  // statement.
  expressionLine: lookahead.parsers("expression line", "expression",
    function (expression) {
      this.newline();
      return expression;
    }),
  ...
  annotations: lookahead.keyword("is", function (strict) {
    var state, values;
  ...
  numberOrString: lookahead.parsers("literal", "string", "number"),
