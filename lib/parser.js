...
lookahead = {
  ...
  newline: function(parser) {
    parser.test = function(value) {
      ...
      return token.type === "newline" || token.value === ";";
    };
...
Parser.prototype = {
  ...
  object: lookahead.keyword("object", function() {
    ...
    return this.braces(function() {
      var inherits = this.lone("inherits");
      return new ast.ObjectConstructor((inherits === null ?
        [] : [inherits]).concat(this.objectBody()));
    });
  }),

  method: lookahead.keyword("method", function() {
    this.keyword("method");
    return this.methodRest("methodBody", function(signature, pattern, body) {
  ...
  "class": lookahead.keyword("class", function() {
    this.keyword("class");
    return this.methodRest("objectBody", function(signature, pattern, body) {
  ...
  methodRest: lookahead.identifier(function(parser, make) {
    ...
    return this.braces(function() {
      return make.call(this, signature, pattern, this.one(parser));
    });
  }),
  ...
  statement: lookahead.parsers("statement",
    "def", "var", "return", "expressionLine", "newline"),

  expression: lookahead.parsers("expression",
    "object", "request", "literal", "parentheses", "prefix", postExpression),
  ...
  string: lookahead.string(function() {
    return new ast.StringLiteral(this.expect("string").value);
  }),
  ...
  peek: function(type) {
    ...
    if (type !== "newline") {
      while (i < l && (token = tokens[i]).type === "newline" &&
          token.indent > this.indent) {
        i++;
      }
    }
