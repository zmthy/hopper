...
function postExpression(expression) {
  ...
  return this.on("operator", function (operator) {
    ...
    if (value === ":=") {
      ...
      if (expression.constructor === ast.Request) {
...
Parser.prototype.parameter = lookahead.parsers("parameter",
...
Parser.prototype.expression = lookahead.parsers("expression", "object", "type",
...
Parser.prototype.prefix = lookahead.operator(function () {
...
Parser.prototype.request = lookahead.identifier(function (receiver) {
...
Parser.prototype.block = lookahead.punctuation("{", function () {
  return this.braces(function () {
    ...
    this.on("parameter", function (param) {
      ...
      // If the parameter has a pattern, or the following token is a comma or
      // a parameter arrow, then it was a parameter.
      if (param.pattern !== null || next.value === "," ||
        ...
        // The expression couldn't have been a parameter, so it must have been
        // a plain identifier. Cast it to a simple Request, perform the
