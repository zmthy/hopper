...
// new Signature(parts : [SignaturePart],
//     pattern : Expression, clauses : [Expression])
//   A list of signature parts combined with optional return pattern and 'where'
//   pattern clause.
function Signature(parts, pattern, clauses, token) {
  Node.call(this, token);
