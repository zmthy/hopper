...
// (this : Request | Method).name() : String
...
// new Method(signature : Signature, body: [Statement])
//   A method.
...
function Parameter(name, pattern, isVarArg) {
  this.name = name;
  this.pattern = pattern;
...
Type.prototype.nameOf = function (i) {
  return name.call({ signature: this.signatures[i] });
};
