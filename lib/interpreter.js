    ...
    function withPatterns(patterns, pattern) {
      ...
      function method() {
        ...
        interpreter.clone().scoped(function(callback) {
          ...
          this.each(zip(patterns.parts, args), function(zipped, callback) {
            this.part(node.name(true), zipped[0], zipped[1], callback);
          }, function(error) {
  ...
  part: function(name, part, args, callback) {
    ...
    function params(error) {
      if (error !== null) {
        ...
        this.each(zip(patterns, args), add, callback);
      }
    }
    ...
    if (generics.length !== 0 &&
      ...
      this.each(zip(part.generics, generics), add, params);
    }
  },
