...
var ast, hop, proto, runtime, undefined, varUnknown;
...
Interpreter.prototype = {
  ...
  block: function(node, callback) {
    var block, interpreter, name, parameters, signature;

    function withApply(apply) {
      var block = new runtime.Object();
  ...
  method: function(node, callback) {
    var body, constructor, init, interpreter, last, name, signature, size;
  ...
  parts: function(name, msig, rsig, callback) {
  ...
  validateParts: function(name, msig, rsig, callback) {
    this.each(msig, rsig, function(mpart, rpart, callback) {
  ...
  part: function(mpart, rpart, callback) {
  ...
  generics: function(mgens, rgens, callback) {
    if (rgens.length !== 0) {
  ...
  parameters: function(params, args, callback) {
  ...
  pattern: function(expression, wrapper, callback) {
    if (expression === null) {
  ...
  arguments: function(names, patterns, args, callback) {
