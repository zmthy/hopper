...
Interpreter.prototype = {
  ...
  apply: function(receiver, method, parts, callback, inheriting) {
    var finished, interpreter, result;
  ...
  method: function(node, callback) {
    ...
    function buildMethod(patterns, pattern) {
      ...
      function method() {
        var args, callback, finished, inheriting, l;
          ...
          function runPart(callback) {
            ...
            this.part(node.name(true), params, args, function(error) {
              ...
              function exit(error, result) {
                ...
                if (error !== null || pattern === runtime.Unknown) {
                  callback.call(this, error, result);
                } else {
