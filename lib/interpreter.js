...
Interpreter.prototype.lets = function (nodes) {
  return this.each(nodes, function (node) {
    var generics, interpreter, name;
    ...
    if (node.constructor === ast.Let) {
      ...
      if (generics.length === 0) {
        return this.expression(node.value).then(function (value) {
          ...
          return this.put(name, this.newDecl(name, 0, function () {
            return value;
          }), node);
        });
      }
      ...
      return this.put(name, this.newDecl(name, generics.length, function () {
...
Interpreter.prototype.newDecl = function (name, generics, func) {
  var decl = rt.method(name, [ [ generics, 0 ] ], func);
